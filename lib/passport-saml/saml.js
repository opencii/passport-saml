...
SAML.prototype.generateAuthorizeRequest = function (req, isPassive, reqForceAuthn, callback) {
  var self = this;
  var id = "_" + self.generateUniqueID();
  var instant = self.generateInstant();
  var forceAuthn = !!(reqForceAuthn === true | self.options.forceAuthn) || false;
...
SAML.prototype.getAuthorizeUrl = function (req, options, callback) {
  var self = this;
  self.generateAuthorizeRequest(req, self.options.passive, options && options.reqForceAuthn || undefined, function(err, request) {
    if (err)
      return callback(err);
...
SAML.prototype.getAuthorizeForm = function (req, options, callback) {
  var self = this;
